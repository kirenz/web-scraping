...
if (!_tb_dis) {
    ...
    var _pmpmk = pm_ppy + '/pmk-202010011.3.js';
    var _pmasync = true;
...
'at': '//meta[@name="article_author"]/@content',
'im': '//meta[@property="og:image"]/@content',
'sx':'//meta[@property="article:section"]/@content',
'opd': ['headline', 'section', 'image', 'author'],
'ablw': ['| NJ Advance Media for NJ.com', '|', 'undefined']
};

var _tb_vpx = [{'xpath': '//div[contains(@class,"youtube")]//iframe', 'attr': 'iframe'}
           ];
